...
# def assert_mean_jit_speedup(initial_runtime: float, jitted_runtimes: np.array, min_speedup_factor=50):
#     mean_speedup = initial_runtime / np.mean(jitted_runtimes)
#     assertGreaterEqual(mean_speedup, min_speedup_factor)     
#     return mean_speedup       
